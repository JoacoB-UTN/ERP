 ...
 * and scroll lock all come for free from the primitive. Byte-identical to
 * Facturación's copy, like the rest of the shared surface (see
 * docs/desktop-ui-direction.md).
 */
