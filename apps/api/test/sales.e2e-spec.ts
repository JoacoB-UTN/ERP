...
describe('Sales (e2e)', () => {
  ...
  afterAll(async () => {
    ...
    // payments first (they point at the sales documents), the movements
    // only once the sales are gone, or the startup backfill can re-create
    // them from documents that are still there. See the helper.
