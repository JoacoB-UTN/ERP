...
/**
 * Shown when the user has an active company but lacks
 * apps.facturacion.access for it — see CLAUDE.md ("backend authorization
 * still protects real operations," this screen is UX, not the security
 * boundary).
 */
export function AppAccessDenied() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 p-6 text-center">
      <p className="text-lg font-medium">No tenés permisos para acceder a Facturación en esta empresa.</p>
